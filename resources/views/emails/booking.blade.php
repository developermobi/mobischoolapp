...
<body>
	...
	<table width="40%" style="background-color: rgba(204, 204, 204, 0.19);border: 1px solid black;">
		...
		<tr><td style="padding: 10px;"><span style="font-size: 14px;color: #8f8b8b;">Date</span><br> {{ $userInfo['show_date'] }}</td><td><span style="font-size: 14px;color: #8f8b8b;">Time</span><br> {{ $userInfo['display_time'] }}</td></tr>
